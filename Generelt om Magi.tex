...
\begin{enumerate}
    ...
    \item Antallet af mana en magibruger har, er det samme som hans optjente XP, en magibruger kan maksimalt opnå 18 mana fra hans XP. Dette inkludere ikke eventuelt tilkøbt mana, skaffet gennem evner eller lignende. 
...
Magien påfører en negativ effekt på offeret, som varer i længere tid.

{\large\textbf{Positiv magi}}\\
Magien påfører en positiv effekt på en spiller, dette kan være i form af mere LP i længere tid eller et skjold. 

{\large\textbf{Øjeblikkelig magi}}\\
Dette er magier, der kun vare et øjeblik. Dette kan fx være helbredende magier eller magier der giver skade.
