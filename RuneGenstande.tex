...
\begin{figure}[H]
    \centering
    \includegraphics[height=5.5cm]{../Evne-Ordbog/setup/Pictures/Nagerune.png}
    \caption{Nagerune}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[height=5.5cm]{../Evne-Ordbog/setup/Pictures/Elementrune.png}
    \caption{Elementrune}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[height=5.5cm]{../Evne-Ordbog/setup/Pictures/Jernrune.png}
    \caption{Jernrune}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[height=5.5cm]{../Evne-Ordbog/setup/Pictures/Dragerune.png}
    \caption{Dragerune}
\end{figure}
...
\begin{runevåben*}[Kelllwans Klinge]
...
\textbf{Ingredienser:} 1 Nagerrune, 1 Enhjørningeblod, 1 Enhjørningehorn.
\end{runevåben*}
...
\begin{runering*}[Hjerteslagets ring]
\textbf{Effekt:} To gang per dag kan du genvinde 2LP ved at sige ”Hjerte bank stærkt”. Du er stadig påvirket af de normale dødsregler hvis du har været på 0LP\\
\textbf{Ingredienser:} 1 drage rune 2 element runer 1 niv 4 helbredende drik 1 sjælestøv
\end{runering*}

\begin{runering*}[Ring af blod og stål]
\textbf{Effekt:} Når du har denne ring på får du + 5NK\\
\textbf{Ingredienser:} 2 Nage runer 1 jern rune 4 jern 2 sulfur
\end{runering*}

\begin{runering*}[Ring af Absorbering]
\textbf{Effekt:} En gang per dag kan du absorbere en pege magi du bliver ramt af. Du skal sige: ”absorberet".\\
\textbf{Ingredienser:} 4 drage runer 4 element runer 4 stjernestøv
\end{runering*}

\begin{runering*}[Ring af Jern]
\textbf{Effekt:} Denne ring tæller som 4 RP. Du kan ikke få mere RP end din professions Maksimum. Dette vil tælle som almindelig rustning som skal repareres når den går i stykker.\\
\textbf{Ingredienser:} 4 Jern runer og 4 stjernestøv
\end{runering*}

\begin{runering*}[Ring af Lyset]
\textbf{Effekt:} Våben du holder bliver hellige. Du skal selv medbringe grønt bånd for at sætte om våbnet. Bruges Hellige Hærge vil denne ring gå i stykker permanent.\\
\textbf{Ingredienser:}  2 Nage runer 2 Drage runer 1 Stjernestøv
\end{runering*}

\begin{runehjelm*}[Hjelm af urokkelig Vilje]
\textbf{Effekt:} Du kan to gange pr dag gøre dig immun over for en af følgende effekter Ærefrygt, Sandhed, Søvn, eller Smerte.\\
\textbf{Ingredienser:}  2 jern runer 1 element rune 4 stjernestøv 
\end{runehjelm*}

\begin{runehjelm*}[Renselsens hjelm]
\textbf{Effekt:} Du kan 2 gange pr dag fjerne en negativ magi du er påvirket af.\\
\textbf{Ingredienser:} 2 Element runer 2 Drage runer 1 jern rune 
\end{runehjelm*}

\begin{runehjelm*}[Taktikerens hjelm]
\textbf{Effekt:} To gange pr dag kan personen med denne hjelm give 2 andre der bære Krigerens Rustning +2 midlertidig LP I 20 Minutter.\\
\textbf{Ingredienser:} 2 Element runer 4 jern runer 1Nager rune  
\end{runehjelm*}

\begin{runehjelm*}[Tykpandens Hjelm]
\textbf{Effekt:} Denne hjelm tæller som 4 RP mere end normalt. Du kan ikke få mere RP end din professions Maksimum. Dette vil tælle som almindelig rustning som skal repareres når den går i stykker.\\
\textbf{Ingredienser:}  4 Jern runer, 2 Flagermus Gødning, og 2 stjernestøv  
\end{runehjelm*}

\begin{runehjelm*}[Troldens Hjelm]
\textbf{Effekt:} Du kan bruges som rambuk til at bryde magiske barriere ned. Hvis i samlet har 20 Nævekamp, kan du løbe eller blive kastet af din gruppe, ind i en magisk barriere, og den vil blive ophævet. Dette vil fjerne alt din RP, da alt din rustning går i stykker.\\
\textbf{Ingredienser:}  2 Drage runer, 2 Element runer, og 1 Orleks Styrke Drik.  
\end{runehjelm*}